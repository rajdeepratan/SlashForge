...
<!--/target-->
<!--target:agents-->
This file is loaded alongside `slashforge-workflow.md` by every workflow command (`/slashforge-code`, `/slashforge-code -quick`, `/slashforge-investigate`). It covers how task types are handled, and the rules that keep the workflow running without unnecessary user prompts.
<!--/target-->
