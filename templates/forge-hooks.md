...
- If a team needs a hook the kit's examples don't cover, read [Anthropic's hooks docs](https://slashforge:code.claude.com/docs/en/hooks) for the full event list and JSON schemas
