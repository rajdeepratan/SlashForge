...
//
// Installed verbatim next to slashforge-report-shell.html. Every command that writes an
...
//
// Usage:  node <path-to-this>/slashforge-splice.js <fragment> <out> <title>
...
if (!frag || !out || title === undefined) {
  console.error('usage: node slashforge-splice.js <fragment> <out> <title>');
  process.exit(2);
}

const shellPath = path.join(__dirname, 'slashforge-report-shell.html');
